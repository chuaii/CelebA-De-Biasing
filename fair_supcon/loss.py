...
class FairSupConLoss(nn.Module):
    """Fair contrastive loss based on SupCon (Khosla et al., NeurIPS 2020).
    See README section 2.2 for full derivation.
    ...
    def forward(self, features, labels, sensitives=None):
        ...
        # logits_mask: exclude self (diagonal)
...
class TotalLoss(nn.Module):
    """L_total = L_CE + lambda * L_FSC (see README section 2.3)."""
